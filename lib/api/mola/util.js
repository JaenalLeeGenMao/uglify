    ...
    return data.map(function (_ref) {
      ...
      return playlists.map(function (playlist) {
        var id = playlist.id,
            ...
            _playlist$attributes$ = _playlist$attributes.images,
            _playlist$attributes$2 = _playlist$attributes$.cover,
            coverTitle = _playlist$attributes$2.title,
            coverBody = _playlist$attributes$2.body,
            coverBG = _playlist$attributes$2.background,
            coverBGColor = _playlist$attributes$2.backgroundColor,
            backgroundRepeat = _playlist$attributes$2.backgroundRepeat,
            poster = _playlist$attributes$2.poster,
            large = _playlist$attributes$.large,
            big = _playlist$attributes$.big,
            medium = _playlist$attributes$.medium,
            small = _playlist$attributes$.small,
            tiny = _playlist$attributes$.tiny;
    ...
    var result = data.map(function (_ref2) {
      ...
      return videos.map(function (video) {
        var id = video.id,
            ...
            _video$attributes$ima = _video$attributes.images,
            _video$attributes$ima2 = _video$attributes$ima.cover,
            coverTitle = _video$attributes$ima2.title,
            coverBody = _video$attributes$ima2.body,
            coverBG = _video$attributes$ima2.background,
            coverBGColor = _video$attributes$ima2.backgroundColor,
            backgroundRepeat = _video$attributes$ima2.backgroundRepeat,
            poster = _video$attributes$ima2.poster,
            large = _video$attributes$ima.large,
            big = _video$attributes$ima.big,
            medium = _video$attributes$ima.medium,
            small = _video$attributes$ima.small,
            tiny = _video$attributes$ima.tiny;

    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        thumbnailPosition === 'bottom' && _react2.default.createElement(
          'div',
          { className: _style.detailWrapper + ' ' + _style.bottomDetail, style: detailStyle },
          children
        ),
        _react2.default.createElement(
          _lazyload2.default,
          {
            ...
            containerClassName: _style.wrapperThumbnail + ' ' + thumbnailPos
          },
          duration && _react2.default.createElement(
            'div',
            { className: _style.durationClass },
            this.getDurationFormatted()
          ),
          thumbnailPosition !== 'bottom' && _react2.default.createElement(
            'div',
            { className: _style.detailWrapper, style: detailStyle },
            children
          )
        )
      );

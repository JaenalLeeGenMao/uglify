...
var VideoThumbnail = function (_Component) {
  ...
  function VideoThumbnail() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = VideoThumbnail.__proto__ || Object.getPrototypeOf(VideoThumbnail)).call.apply(_ref, [this].concat(args))), _this), _this.getDurationFormatted = function () {
  ...
  _createClass(VideoThumbnail, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          _props$onErrorShowDef = _props.onErrorShowDefault,
          onErrorShowDefault = _props$onErrorShowDef === undefined ? false : _props$onErrorShowDef,
          ...
          _props$errorImgClassN = _props.errorImgClassName,
          errorImgClassName = _props$errorImgClassN === undefined ? '' : _props$errorImgClassN,
      ...
      return _react2.default.createElement(
        'div',
        { className: _style.wrapper + ' ' + (className || '') },
        thumbnailPosition === 'bottom' && _react2.default.createElement(
          _lazyload2.default,
          {
            className: _style.detailWrapper + '  ' + _style.bottomDetail,

...
var Player = /*#__PURE__*/function (_Component) {
  ...
  function Player() {
              ...
              if (ads.length > 0) {
                ...
                if (activeAds) {
                  ...
                  if (_this.player) {
                    ...
                    video = document.getElementById(_this.props.id || 'video-main');
    ...
    _defineProperty(_assertThisInitialized(_this), "handleSubtreeOnChange", function () {
      var videoHeight = (0, _get2["default"])(document.getElementById(_this.props.id || 'video-main'), 'offsetHeight', '');
  ...
  _createClass(Player, [{
    ...
    value: function render() {
      ...
      var controllerConfig = _objectSpread({
        ...
        ,
        primary: primary
        /** used to identify primary player, and disable keyboard shortcuts */

...
var Player = /*#__PURE__*/function (_Component) {
  ...
  function Player() {
    ...
    _defineProperty(_assertThisInitialized(_this), "initPlayer", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
      var drm, streamSourceUrl, currentTime, watchTimePosition, video, player, isSafari, startTime, drmStreamUrl, manifestUri, deviceId, req, cert, config, _config;
              ...
              config = {
                ...
                drm: {
                  ...
                  advanced: {
                    ...
                    initDataTransform: function initDataTransform(initData) {
                      var skdUri = shaka.util.StringUtils.fromBytesAutoDetect(initData);
                      /* 'initData' is a buffer containing an 'skd://' URL as a UTF-8 string. */

                      if (!skdUri.includes('skd')) return initData;
                      var contentId = shaka.util.FairPlayUtils.defaultGetContentId(skdUri);
    ...
    _defineProperty(_assertThisInitialized(_this), "handleInitPlayer", function (player, config) {
      ...
      var HTTP_IN_HEX = 0x68747470;
      var RequestType = shaka.net.NetworkingEngine.RequestType;
      player.getNetworkingEngine().registerResponseFilter( /*#__PURE__*/function () {
        var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(type, response) {
          var dataView, responseAsString, uris, redirectRequest, requestOperation, redirectResponse;
          return regeneratorRuntime.wrap(function _callee3$(_context3) {
            while (1) {
              switch (_context3.prev = _context3.next) {
                ...
                case 2:
                  dataView = new DataView(response.data);
                ...
                case 5:
                  ...
                  responseAsString = shaka.util.StringUtils.fromUTF8(response.data); // Make another request for the redirect URL.

                  uris = [responseAsString];
                  redirectRequest = shaka.net.NetworkingEngine.makeRequest(uris, retryParameters); // NOTE: Only do this if the purpose of the redirect is authentication.  If
                  // the ALR is meant for something like load-balancing, remove the next line.

                  redirectRequest.allowCrossSiteCredentials = true;
                  requestOperation = player.getNetworkingEngine().request(type, redirectRequest);
                  _context3.next = 12;
                  return requestOperation.promise;
  ...
  _createClass(Player, [{
    ...
    value: function componentDidMount() {
      ...
      if (process.env.BROWSER && window) {
        ...
        _config2.ShakaScript.map(function (script) {

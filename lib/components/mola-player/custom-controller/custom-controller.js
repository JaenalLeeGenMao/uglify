...
var CustomController = /*#__PURE__*/function (_Component) {
  ...
  function CustomController() {
    ...
    _defineProperty(_assertThisInitialized(_this), "_getElementById", function (id) {
      var customControllerId = "vpcc-custom-controller-".concat(_this.props.id);
      return document.querySelector("#".concat(customControllerId, " #").concat(id));
    });

    _defineProperty(_assertThisInitialized(_this), "handleFeedbackOnClick", function () {
      // console.log('feedback clicked...')
      var quality = _this._getElementById('vpcc-quality'),
          qualityPopupEl = (0, _get2["default"])(quality, 'children[0]', '');

      var subtitle = _this._getElementById('vpcc-subtitle'),
    ...
    _defineProperty(_assertThisInitialized(_this), "handleKeyboardEvent", function () {
      if (_this.props.config.keyboardShortcutsEnabled) {
    ...
    _defineProperty(_assertThisInitialized(_this), "initEventListeners", function (player) {
      var seek = _this._getElementById('vpcc-seek'),
    ...
    _defineProperty(_assertThisInitialized(_this), "_updateSeekTooltip", function (event) {
      ...
      if (video && !isPreroll && !isLive) {
        var seekTooltip = _this._getElementById('vpcc-seek-tooltip');
    ...
    _defineProperty(_assertThisInitialized(_this), "_updateVolume", function (e) {
      ...
      var volume = _this._getElementById('vpcc-volume');
    ...
    _defineProperty(_assertThisInitialized(_this), "_seekTo", function (n) {
      ...
      if (n > 0 && !_this.props.config.showForwardButton) return false;
      if (n < 0 && !_this.props.config.showBackwardButton) return false;
      /** prevent seek end */
  ...
  _createClass(CustomController, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, this.renderFeedback(), this.renderCue(), /*#__PURE__*/_react["default"].createElement("div", {
        id: "vpcc-custom-controller-".concat(this.props.id),
      ...
      }, !isPaused ? 'Pause' : 'Play', " (p)")), !isLive && !isPreroll && /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, this.props.config.showForwardButton && /*#__PURE__*/_react["default"].createElement(_customController.Icons, {
        ...
        className: 'tooltip withTooltip'
      }, "Forward (\u2B62)")), this.props.config.showBackwardButton && /*#__PURE__*/_react["default"].createElement(_customController.Icons, {

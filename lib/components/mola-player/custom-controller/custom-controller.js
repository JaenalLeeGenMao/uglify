...
var CustomController = /*#__PURE__*/function (_Component) {
  ...
  function CustomController() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleKeyboardEvent", function () {
      if (!_this.props.config.primary) return true;
      /** prevent keyboard shortcuts if NOT primary player */
  ...
  _createClass(CustomController, [{
    ...
    value: function componentWillUnmount() {
      if (!this.props.config.primary) return true;
      /** prevent keyboard shortcuts removal if NOT primary player */

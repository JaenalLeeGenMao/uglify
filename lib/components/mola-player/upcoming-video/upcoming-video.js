    ...
    _defineProperty(_assertThisInitialized(_this), "redirectToNextVideo", function (videoId) {
      if (window) {
        ...
        if (window.globalHistory) {
          window.globalHistory.push("/watch?v=".concat(videoId, "&autoplay=1"));
        } else {
          window.location.href = "/watch?v=".concat(videoId, "&autoplay=1");
        }
      }
    });
  ...
  _createClass(UpcomingVideo, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        className: 'play',
        href: "/watch?v=".concat(data.id, "&autoplay=1")

  ...
  _createClass(Theoplayer, [{
    ...
    value: function loadTheoPlayer() {
      var _props = this.props,
          ...
          handleOnVideoPause = _props.handleOnVideoPause,
          handleOnVideoPlay = _props.handleOnVideoPlay,
          poster = _props.poster,
          adsBannerUrl = _props.adsBannerUrl,
          adsBannerOptions = _props.adsBannerOptions,
          resizeBannerAndCBarEnabled = _props.resizeBannerAndCBarEnabled;
...
Theoplayer.defaultProps = {
  ...
  handleVideoTimeUpdate: function handleVideoTimeUpdate() {},

...
var Theoplayer = function (_Component) {
  ...
  function Theoplayer() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Theoplayer.__proto__ || Object.getPrototypeOf(Theoplayer)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var verimatrixDRMConfiguration = void 0;
      if (drm) {
        verimatrixDRMConfiguration = {
          fairplay: {
            licenseAcquisitionURL: drm.fairplay ? '' + drm.fairplay.licenseUrl + qs : '',
            certificateURL: drm.fairplay ? '' + drm.fairplay.certificateUrl + qs : ''
          },
          playready: {
            licenseAcquisitionURL: drm.playready ? '' + drm.playready.licenseUrl + qs : ''
          },
          widevine: {
            licenseAcquisitionURL: drm.widevine ? '' + drm.widevine.licenseUrl + qs : ''
          }
        };
      }
    ...
    }, _this.handleVideoVolumeChange = function () {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        showBackBtn && _react2.default.createElement(
          'div',
          { className: _style.arrowContainer, onClick: this.handleGoBack },
          !isFullscreen && _react2.default.createElement('span', { className: _style.arrowIcon }),
          isFullscreen && _react2.default.createElement('span', { className: _style.closeIcon })
        ),
        children
      );
    }
...
Theoplayer.propTypes = {
  ...
  handleOnVideoVolumeChange: _propTypes2.default.func,
  ...
  deviceId: _propTypes2.default.string,
  drm: _propTypes2.default.object,
  handleOnReadyStateChange: _propTypes2.default.func
};

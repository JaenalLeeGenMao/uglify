...
var Theoplayer = function (_Component) {
  ...
  function Theoplayer() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Theoplayer.__proto__ || Object.getPrototypeOf(Theoplayer)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var verimatrixDRMConfiguration = JSON.parse(JSON.stringify(_config.verimatrixDRMConf));

      verimatrixDRMConfiguration.fairplay.licenseAcquisitionURL = _config.verimatrixDRMConf.fairplay.licenseAcquisitionURL + '?deviceId=' + deviceId;
      verimatrixDRMConfiguration.playready.licenseAcquisitionURL = _config.verimatrixDRMConf.playready.licenseAcquisitionURL + '?deviceId=' + deviceId;
      verimatrixDRMConfiguration.widevine.licenseAcquisitionURL = _config.verimatrixDRMConf.widevine.licenseAcquisitionURL + '?deviceId=' + deviceId;
...
Theoplayer.propTypes = {
  ...
  isDRM: _propTypes2.default.bool
};

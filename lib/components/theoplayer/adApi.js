...
var AdBanner = function () {
    ...
    _createClass(AdBanner, [{
            ...
            if (this.ipaEnabled && this.ipaRequestUrl) {
                ...
                xhttp.onreadystatechange = function () {
                    ...
                    if (xhttp.readyState === 4 && xhttp.status === 200) {
                        ...
                        var ads = response.data; //ini jadi response.data.data
                        var imgURL = void 0,
        ...
        value: function initIpa(imgUrl, clickthroughUrl, id) {
            ...
            var dimensionChangeListener = this.resizeBannerAndControlBar.bind(this, playerContainer, wrapper, bannerContainer, controlBar);

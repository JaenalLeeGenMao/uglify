...
var AdBanner = /*#__PURE__*/function () {
  function AdBanner(_ref) {
    var player = _ref.player,
        ...
        ipaEnabled = _ref$ipaEnabled === void 0 ? true : _ref$ipaEnabled,
        _ref$ipaDuration = _ref.ipaDuration,
        ipaDuration = _ref$ipaDuration === void 0 ? 30 : _ref$ipaDuration,
        _ref$ipaVisibility = _ref.ipaVisibility,
        ipaVisibility = _ref$ipaVisibility === void 0 ? true : _ref$ipaVisibility,
        _ref$ipaNoAdsTime = _ref.ipaNoAdsTime,
        ipaNoAdsTime = _ref$ipaNoAdsTime === void 0 ? 30 : _ref$ipaNoAdsTime,
        _ref$closable = _ref.closable,
        closable = _ref$closable === void 0 ? true : _ref$closable,
        _ref$skipOffset = _ref.skipOffset,
        skipOffset = _ref$skipOffset === void 0 ? 0 : _ref$skipOffset,
        _ref$ipaTimeOffset = _ref.ipaTimeOffset,
        ipaTimeOffset = _ref$ipaTimeOffset === void 0 ? 0 : _ref$ipaTimeOffset,
        _ref$araRefreshTime = _ref.araRefreshTime,
        araRefreshTime = _ref$araRefreshTime === void 0 ? 60 : _ref$araRefreshTime,
        _ref$araResume = _ref.araResume,
        araResume = _ref$araResume === void 0 ? true : _ref$araResume,
        _ref$araEnabled = _ref.araEnabled,
        araEnabled = _ref$araEnabled === void 0 ? false : _ref$araEnabled,
        _ref$resizeBannerAndC = _ref.resizeBannerAndCBarEnabled,
        resizeBannerAndCBarEnabled = _ref$resizeBannerAndC === void 0 ? true : _ref$resizeBannerAndC;
    ...
    this.resizeBannerAndCBarEnabled = resizeBannerAndCBarEnabled; // IPA banner dimension

    this.BANNER_ASPECT_WIDTH = 377;
    this.BANNER_ASPECT_HEIGHT = 30;
    this.VIDEO_ASPECT_WIDTH = 16;
    this.VIDEO_ASPECT_HEIGHT = 9; // sources

    this.currentAd = {};
    this.araAdsFromServer = []; // timers

    this.globalTime = 0;
    this.timeOffsetTimer = null;
    this.rotationTimer = null;
    this.araRequestTimer = null;
    this.noIpaAdsTimer = null; // api helpers
    ...
    this.isThisAdAlredySheduled = null; // ui helpers

    this.playerControls = {};
    this.ipaStyleAttached = false;
    this.closeElement = null;
    this.resetControls = false; // custom event listener functions: "adchange"

    this.listeners = new Map(); // global binded functions used in even listeners
  ...
  _createClass(AdBanner, [{
    key: "init",
    value: function init() {
      this.player.addEventListener('timeupdate', this.sheduleAfterFirstStreamLoad); //if (!this.streamListener) {
    ...
    value: function araRequest() {
      ...
      if (this.araEnabled && this.araRequestUrl) {
        this.araRequestTimer = setTimeout(function () {
          _this2.araAdsFromServer = []; //ARA REQUEST
    ...
    value: function initARA() {
      ...
      this.araAdsFromServer.forEach(function (ad) {
        ...
        _this3.player.ads.schedule({
          sources: ad.adTag,
          timeOffset: adTimeOffsetScheduleValue,
          skipOffset: _this3.closable ? _this3.setSkipOffsetIfClosable : -1
        });
      });
    ...
    value: function initIpa(imgUrl, clickthroughUrl, id) {
      ...
      if (!this.isThisAdAlredySheduled) {
        this.player.ads.schedule({
          sources: url,
          skipOffset: this.setSkipOffsetIfClosable
        });
      }
...
function mobileAdInit(_ref2) {
  ...
  mobileAdApi = new AdBanner({
    player: player,
    ipaRequestUrl: ipaRequestUrl,
    araRequestUrl: araRequestUrl,
    ipaEnabled: ipaEnabled,
    araEnabled: araEnabled,
    ipaDuration: ipaDuration,
    ipaVisibility: ipaVisibility,
    ipaTimeOffset: ipaTimeOffset,
    araRefreshTime: araRefreshTime,
    araResume: araResume,
    closable: closable,

  ...
  _createClass(LazyLoad, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          src = _props.src,
          errorImgClassName = _props.errorImgClassName,
          onErrorShowDefault = _props.onErrorShowDefault;
      ...
      return _react2.default.createElement(
        ...
        src && _react2.default.createElement('img', { ref: this.image, className: className, style: isError && onErrorShowDefault ? { display: 'none' } : style, src: sources, alt: alt }),
        isError && _react2.default.createElement('div', { className: _style.errorBg + ' ' + errorImgClassName }),
        children
      );
    }
  }, {

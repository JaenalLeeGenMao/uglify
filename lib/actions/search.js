...
var getSearchResult = exports.getSearchResult = function getSearchResult(searchText) {
  return function (dispatch) {
    ...
    _dexie2.default.exists('search-cache-database').then(function (exists) {
      var _this = this;
      ...
      if (exists) {
        _searchDb2.default.transaction('r', _searchDb2.default.moviesResult, _searchDb2.default.castsResult, _searchDb2.default.searchKeyword, _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
          ...
          if (!isExist) {
            ...
            return _common2.default.getSearchResult({ q: searchText }).then(function (result) {
...
var getSearchGenre = exports.getSearchGenre = function getSearchGenre() {
  return function (dispatch) {
    dispatch({
    ...
    return _common2.default.getSearchGenre().then(function (result) {
      if (result.meta.status === 'error') {
        dispatch({
...
var getRecentSearch = exports.getRecentSearch = function getRecentSearch(sessionId) {
  return function (dispatch) {
    dispatch({
    ...
    return _common2.default.getRecentSearch(sessionId).then(function (result) {
      if (result.meta.status === 'error') {
        dispatch({

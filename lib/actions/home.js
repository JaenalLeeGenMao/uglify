...
var getHomePlaylist = exports.getHomePlaylist = function getHomePlaylist() {
  return function (dispatch) {
    ...
    return _mola2.default.getHomePlaylist(_extends({}, _config2.default)).then(function (result) {
...
var getHomeVideo = exports.getHomeVideo = function getHomeVideo(playlist) {
  return function (dispatch) {
    return _mola2.default.getHomeVideo(_extends({ id: playlist.id }, _config2.default)).then(function (result) {
      result = {
        meta: {

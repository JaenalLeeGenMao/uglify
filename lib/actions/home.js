...
var getHomePlaylist = function getHomePlaylist() {
  return function (dispatch) {
    ...
    return _mola2.default.getHomePlaylist().then(function (result) {
...
var getHomeVideo = function getHomeVideo(playlist) {
  return function (dispatch) {
    return _mola2.default.getHomeVideo({ id: playlist.id }).then(function (result) {
      result = {
        meta: {
...
var updateActivePlaylist = function updateActivePlaylist(id) {
...
exports.updateActivePlaylist = updateActivePlaylist;
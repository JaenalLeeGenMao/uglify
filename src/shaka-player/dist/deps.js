...
goog.addDependency('../../../lib/dash/content_protection.js', ['shaka.dash.ContentProtection'], ['goog.asserts', 'shaka.log', 'shaka.util.Error', 'shaka.util.ManifestParserUtils', 'shaka.util.Pssh', 'shaka.util.Uint8ArrayUtils', 'shaka.util.XmlUtils']);
...
goog.addDependency('../../../lib/media/playhead.js', ['shaka.media.MediaSourcePlayhead', 'shaka.media.Playhead', 'shaka.media.SrcEqualsPlayhead'], ['goog.asserts', 'shaka.log', 'shaka.media.GapJumpingController', 'shaka.media.TimeRangesUtils', 'shaka.media.VideoWrapper', 'shaka.util.IReleasable', 'shaka.util.MediaReadyState', 'shaka.util.Timer']);
...
goog.addDependency('../../../lib/media/video_wrapper.js', ['shaka.media.VideoWrapper', 'shaka.media.VideoWrapper.PlayheadMover'], ['goog.asserts', 'shaka.log', 'shaka.util.EventManager', 'shaka.util.IReleasable', 'shaka.util.MediaReadyState', 'shaka.util.Timer']);
...
goog.addDependency('../../../lib/offline/download_manager.js', ['shaka.offline.DownloadManager'], ['goog.asserts', 'shaka.net.NetworkingEngine', 'shaka.offline.DownloadProgressEstimator', 'shaka.util.Error', 'shaka.util.IDestroyable', 'shaka.util.Pssh']);
...
goog.addDependency('../../../lib/polyfill/patchedmediakeys_apple.js', ['shaka.polyfill.PatchedMediaKeysApple'], ['goog.asserts', 'shaka.log', 'shaka.polyfill.register', 'shaka.util.EventManager', 'shaka.util.FakeEvent', 'shaka.util.FakeEventTarget', 'shaka.util.MediaReadyState', 'shaka.util.PublicPromise', 'shaka.util.Uint8ArrayUtils']);
goog.addDependency('../../../lib/polyfill/patchedmediakeys_ms.js', ['shaka.polyfill.PatchedMediaKeysMs'], ['goog.asserts', 'shaka.log', 'shaka.polyfill.register', 'shaka.util.EventManager', 'shaka.util.FakeEvent', 'shaka.util.FakeEventTarget', 'shaka.util.MediaReadyState', 'shaka.util.Pssh', 'shaka.util.PublicPromise', 'shaka.util.Uint8ArrayUtils']);
...
goog.addDependency('../../../lib/util/fairplay_utils.js', ['shaka.util.FairPlayUtils'], ['goog.Uri', 'goog.asserts']);
...
goog.addDependency('../../../lib/util/media_ready_state_utils.js', ['shaka.util.MediaReadyState'], []);
...
goog.addDependency('../../../lib/util/stream_utils.js', ['shaka.util.StreamUtils'], ['goog.asserts', 'shaka.log', 'shaka.media.DrmEngine', 'shaka.media.MediaSourceEngine', 'shaka.text.TextEngine', 'shaka.util.Functional', 'shaka.util.LanguageUtils', 'shaka.util.ManifestParserUtils', 'shaka.util.MimeUtils', 'shaka.util.MultiMap']);
